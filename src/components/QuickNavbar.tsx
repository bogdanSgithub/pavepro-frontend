  ...
  return (
    <nav className="lg:sticky top-0 z-50 bg-white shadow-sm">
      ...
      style={{
        ...
        <div className="hidden lg:flex items-center space-x-2">
          ...
          <Link className='w-full' to="/">
            <Button variant="important" className="px-10 py-6 2xl:px-14 text-xl">{t("home")}</Button>
          </Link>
      ...
      <div className="flex flex-col items-center space-y-4 px-6 mt-4">
        <a href="tel:+15149717709" className="w-full mb-1">
          <Button
            variant="ghost"
        ...
        <a href="mailto:pavepro.services@gmail.com?subject=Request for Quote" className="w-full">
          <Button
            variant="ghost"
            className="w-full text-[1.05rem] hover:scale-100"
          >
